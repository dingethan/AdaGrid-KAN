...
[交互式可视化](visualization/index.html) · [EcoGrow 对比脚本](examples/ecogrow_comparison.py)
...
[visualization/index.html](visualization/index.html) 包含：

- EcoGrow 概览、时间线、**代价感知决策计算器**
- seed 42 与五种子结果表（集中数据对象）
- 实验图表
- **原有 AdaGrid vs 固定 Grid 交互演示**（播放/暂停训练模拟）
...
**Grow the spline grid only when validation improvement justifies the added parameters.**

[Interactive visualization](visualization/index.html) · [EcoGrow comparison script](examples/ecogrow_comparison.py)
...
[visualization/index.html](visualization/index.html) includes:

- EcoGrow overview, timeline, and **cost-aware decision calculator**
- Seed-42 and five-seed result tables (from a centralized data object)
- Experiment figures
- **Original interactive AdaGrid vs fixed-Grid demo** (play/pause training simulation)
